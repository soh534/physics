...
int Simulation(int argc, char* argv[])
{
	 ...
	 int bIdA, bIdB;
    {
		...
		vertices.push_back(Point3(-18.0f, 36.0f));
        vertices.push_back(Point3(-30.0f, 6.0f));
        vertices.push_back(Point3(42.0, -6.0));
        vertices.push_back(Point3(-30.0f, -30.0f));
        vertices.push_back(Point3(12.0f, -60.0f));
        vertices.push_back(Point3(30.0f, 18.0f));
...
#if 0
    {
        physicsBodyCinfo cinfo;
        vector<Point3> vertices;
		vertices.push_back(Point3(20.0f, -40.0f));
        vertices.push_back(Point3(40.0f, -30.0f));
        vertices.push_back(Point3(50.0f, -20.0f));
        vertices.push_back(Point3(50.0f, 10.0f));
        vertices.push_back(Point3(20.0f, 40.0f));
        vertices.push_back(Point3(-10.0f, 40.0f));
		vertices.push_back(Point3(-40.0f, 10.0f));
        vertices.push_back(Point3(-40.0f, -30.0f));
        vertices.push_back(Point3(-30.0f, -40.0f));
        cinfo.m_shape = new physicsConvexShape(vertices, .1f);
...
#if 1
	{
		physicsBodyCinfo cinfo;
		vector<Point3> vertices;
		vertices.push_back(Point3(40.0f, -40.0f));
		vertices.push_back(Point3(40.0f, 40.0f));
		vertices.push_back(Point3(-40.0f, -40.0f));
		vertices.push_back(Point3(-40.0f, 40.0f));
		cinfo.m_shape = new physicsConvexShape(vertices, .1f);
...
#if 1
    {
		...
		physicsBodyCinfo cinfo;
		vector<Point3> vertices;
		vertices.push_back(Point3(25.f, 200.f));
		vertices.push_back(Point3(-25.f, 250.f));
		vertices.push_back(Point3(-25.f, -250.f));
		vertices.push_back(Point3(25.f, -200.f));
		cinfo.m_shape = new physicsConvexShape(vertices, .1f);
...
#if 1
	{
		...
		physicsBodyCinfo cinfo;
		vector<Point3> vertices;
		vertices.push_back(Point3(-400.f, -25.f));
		vertices.push_back(Point3(-450.f, 25.f));
		vertices.push_back(Point3(450.f, 25.f));
		vertices.push_back(Point3(400.f, -25.f));
		cinfo.m_shape = new physicsConvexShape(vertices, .1f);
		cinfo.m_type = physicsMotionType::STATIC;
