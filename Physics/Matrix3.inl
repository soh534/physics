...
inline void Matrix3::setTranslationUnit( const Vector3& translation )
{
	...
	m_data[2][2] = translation( 2 );
}

inline Vector3 Matrix3::getTranslationUnit() const
{
	return Vector3( m_data[0][2], m_data[1][2], m_data[2][2] );
}
...
inline Real Matrix3::getRotationUnit() const
{
	return Real();
}
